...
urlpatterns = [
    ...
    path("productocategoria/create/", staff_member_required(views.ProductoCategoriaCreate.as_view()), name="productocategoria_form"),
    ...
    path("producto/create/", staff_member_required(views.ProductoCreate.as_view()), name="producto_form"),
